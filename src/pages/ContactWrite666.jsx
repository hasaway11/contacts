...
function ContactWrite() {
  ...
  const nameInput = useInput(nameRef);
  const telInput = useInput(telRef);
  const addressInput = useInput(addressRef);
  ...
  return (
    <>
      ...
      <InputField name="name" label="이름" type="text" {...nameInput} ref={nameRef} />
      <InputField name="address" label="주소" type="text" {...addressInput} ref={addressRef} />
      <InputField name="tel" label="연락처" type="text" {...telInput} ref={telRef} />
